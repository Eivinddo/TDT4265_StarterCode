...
class AnchorBoxesTester(object):
    def __init__(self, 
        ...
        for fidx, [fH, fW] in enumerate(feature_sizes):
            ...
            ax.scatter(h_min * w_min * W * H, 1, s=70, facecolors='dimgray', edgecolors='k')
            ...
            ax.scatter(h_max * w_max * W * H, 1, s=70, facecolors='dimgray', edgecolors='k')
...
anchors = AnchorBoxesTester(
    ...
    min_sizes=[[8, 8], [24, 24], [40, 40], [60, 60], [86, 86], [128, 128], [128, 400]],
